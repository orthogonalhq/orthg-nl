...
flowchart LR
  ...
  classDef worker fill:#1a1a1a,stroke:#FA5D2B,stroke-width:1px,color:#D9D9D9
  classDef decision fill:#141414,stroke:#555555,stroke-width:1px,color:#B3B3B3
  classDef event fill:#141414,stroke:#333333,stroke-width:1px,color:#8C8C8C
